#!/bin/bash
# Run Multiple Instances of App Insights Dashboard
# Each instance can have different port and API endpoint
...
# Build the image once (if not already built)
...
# Instance 1: SAN Region on port 8080
...
# Instance 2: US East Region on port 9090
...
# Instance 3: EU West Region on port 7070
