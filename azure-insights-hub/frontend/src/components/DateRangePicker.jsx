...
export default function DateRangePicker({ startDate, endDate, onChange, onApply, onClear }) {
  ...
  const applyPreset = (startD, endD, sTime = "00:00", eTime = "23:59") => {
  ...
  const presets = [
    { label: "Last 30 min",  fn: () => { const e = new Date(); const s = new Date(e.getTime() - 30*60000); applyPreset(s, e, `${String(s.getHours()).padStart(2,'0')}:${String(s.getMinutes()).padStart(2,'0')}`, `${String(e.getHours()).padStart(2,'0')}:${String(e.getMinutes()).padStart(2,'0')}`); } },
    { label: "Last 1 hour",  fn: () => { const e = new Date(); const s = new Date(e.getTime() - 60*60000); applyPreset(s, e, `${String(s.getHours()).padStart(2,'0')}:${String(s.getMinutes()).padStart(2,'0')}`, `${String(e.getHours()).padStart(2,'0')}:${String(e.getMinutes()).padStart(2,'0')}`); } },
    { label: "Last 3 hours", fn: () => { const e = new Date(); const s = new Date(e.getTime() - 3*60*60000); applyPreset(s, e, `${String(s.getHours()).padStart(2,'0')}:${String(s.getMinutes()).padStart(2,'0')}`, `${String(e.getHours()).padStart(2,'0')}:${String(e.getMinutes()).padStart(2,'0')}`); } },
    { label: "Last 6 hours", fn: () => { const e = new Date(); const s = new Date(e.getTime() - 6*60*60000); applyPreset(s, e, `${String(s.getHours()).padStart(2,'0')}:${String(s.getMinutes()).padStart(2,'0')}`, `${String(e.getHours()).padStart(2,'0')}:${String(e.getMinutes()).padStart(2,'0')}`); } },
    { label: "Last 12 hours",fn: () => { const e = new Date(); const s = new Date(e.getTime() - 12*60*60000); applyPreset(s, e, `${String(s.getHours()).padStart(2,'0')}:${String(s.getMinutes()).padStart(2,'0')}`, `${String(e.getHours()).padStart(2,'0')}:${String(e.getMinutes()).padStart(2,'0')}`); } },
    { label: "Today",        fn: () => { const s = new Date(); s.setHours(0,0,0,0); applyPreset(s, new Date(), "00:00", `${String(new Date().getHours()).padStart(2,'0')}:${String(new Date().getMinutes()).padStart(2,'0')}`); } },
    { label: "Yesterday",    fn: () => { const s = new Date(); s.setDate(s.getDate()-1); s.setHours(0,0,0,0); const e = new Date(s); e.setHours(23,59,59,999); applyPreset(s, e, "00:00", "23:59"); } },
    { label: "Last 7 days",  fn: () => { const s = new Date(); s.setDate(s.getDate()-7); s.setHours(0,0,0,0); applyPreset(s, new Date(), "00:00", `${String(new Date().getHours()).padStart(2,'0')}:${String(new Date().getMinutes()).padStart(2,'0')}`); } },
    { label: "Last 30 days", fn: () => { const s = new Date(); s.setDate(s.getDate()-30); s.setHours(0,0,0,0); applyPreset(s, new Date(), "00:00", `${String(new Date().getHours()).padStart(2,'0')}:${String(new Date().getMinutes()).padStart(2,'0')}`); } },
    { label: "This month",   fn: () => { const s = new Date(); s.setDate(1); s.setHours(0,0,0,0); applyPreset(s, new Date(), "00:00", `${String(new Date().getHours()).padStart(2,'0')}:${String(new Date().getMinutes()).padStart(2,'0')}`); } },
    { label: "Last month",   fn: () => { const s = new Date(); s.setDate(1); s.setMonth(s.getMonth()-1); s.setHours(0,0,0,0); const e = new Date(); e.setDate(0); e.setHours(23,59,59,999); applyPreset(s, e, "00:00", "23:59"); } },
  ];
