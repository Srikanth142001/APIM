      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%", maxWidth: 420 }}>
        ...
        <div
          style={{
            ...
            border: isLight
              ? "1px solid rgba(26,79,170,0.2)"
              : "1px solid rgba(87,148,242,0.2)",
            borderRadius: 16,
            padding: "40px 36px",
            boxShadow: isLight
            ...
            <div
              style={{
                ...
                border: isLight
                  ...
                  : "1px solid rgba(87,148,242,0.3)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                margin: "0 auto 16px",
                boxShadow: isLight
                  ? "0 0 32px rgba(26,79,170,0.1)"
                  : "0 0 32px rgba(87,148,242,0.15)",
              }}
            >
              <span
                style={{
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <input
                ...
                onFocus={(e) => {
                  ...
                  e.target.style.boxShadow = `0 0 0 3px ${T.blue}22`;
                }}
                onBlur={(e) => {
